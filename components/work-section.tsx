...
const experiments = [
  {
    ...
    medium: "Step 1",
    description: "School administrators create their institutional profile and configure classes, subjects, and user roles.",
    span: "col-span-2 row-span-2",
  },
  {
    title: "Teachers Join",
    medium: "Step 2",
    description: "Teachers onboard to the platform and gain access to their assigned classes and student lists.",
    span: "col-span-1 row-span-1",
  },
  {
    title: "Students & Parents Connect",
    medium: "Step 3",
    description: "Students and parents log in to receive updates, assignments, schedules, and announcements.",
    span: "col-span-1 row-span-2",
  },
  {
    title: "Assignments & Updates Shared",
    medium: "Step 4",
    description: "Teachers post homework, resources, attendance, and notices in one centralized system.",
    span: "col-span-1 row-span-1",
  },
  {
    title: "Tracking & Notifications",
    medium: "Step 5",
    description: "Real-time notifications ensure deadlines, submissions, and important updates are never missed.",
    span: "col-span-2 row-span-1",
  },
  {
    title: "Performance Insights",
    medium: "Step 6",
    description: "Analytics dashboards provide insights into participation, attendance, and academic progress.",
    span: "col-span-1 row-span-1",
  },
  {
    title: "Continuous Communication",
    medium: "Step 7",
    description: "Integrated messaging strengthens collaboration between schools, parents, and students.",
    span: "col-span-1 row-span-1",
  },
]
